...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Jewelery">
    <meta name="keywords" content="HTML,CSS,XML,JavaScript">
    <meta name="author" content="Zaadie Fourie">
...
<body id="index_body">
    ...
    <!--
    <div id="handcrafted">
        <h2>Handcrafted Jewles, Belts and Buckles. </h2>
    </div>
-->
    ...
    <div class="box1"><img src="media/photography/bodyimg.png" id="mainimg"></div>
</body>
